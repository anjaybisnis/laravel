		...
		<div class="container-fluid">
			<div class="row equal align-items-center fullscreen">
				...
				<div class="col-lg-4 offset-lg-2 signup-form ">
					<h1 class="mr-20">{{ HP::set()->title }} - Daftar</h1>
					<p>Masukkan detail informasi untuk mendaftarkan akun Anda</p>
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        @csrf
							<div class="form-group">
								<label class="text-uppercase">Username</label>
								<input name="name" type="text" placeholder="Masukkan Username" onfocus="this.placeholder=''" onblur="this.placeholder = 'Masukkan Username'" required class="common-input mt-10">
							</div>
							<div class="form-group">
							...
							<!-- <div class="form-group">
								...
								<input name="password_confirmation" type="password" placeholder="Masukkan Password" onfocus="this.placeholder=''" onblur="this.placeholder = 'Masukkan Password'" required class="common-input mt-10">
							</div> -->
                            <div class="form-group">
                                <label class="text-uppercase">Tipe Akun</label>
                                <select class="common-input mt-10" name="role" required>
                          ...
                          <div class="mt-20">
                            ...
                            <label for="login-1">Ingat Saya</label>
                          </div>
                          <button class="primary-btn view-btn mt-20 mr-20 mb-20"><span>Daftar</span></button>
					</form>
				</div>
				<a class="primary-btn white-btn signup-btn" href="{{ route('login') }}">Masuk</a>
			</div>
		</div>
	</section>
	<!-- End login-form Area -->
