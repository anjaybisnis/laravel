...
@section('container')
    ...
    <div class="buttons">
        <!-- <a href="{{ route('LaravelVisualInstaller::environmentWizard') }}" class="button button-wizard">
            <i class="fa fa-sliders fa-fw"
               aria-hidden="true"></i> {{ trans('installer_messages.environment.menu.wizard-button') }}
        </a> -->
        <a href="{{ route('LaravelVisualInstaller::environmentClassic') }}" class="button button-classic">
