...
@section('container')
    ...
    <form method="post" action="{{ route('LaravelVisualInstaller::environmentSaveClassic') }}">
        {!! csrf_field() !!}
    ...
    @if( ! isset($environment['errors']))
        <div class="buttons-container">
            <!-- <a class="button float-left" href="{{ route('LaravelVisualInstaller::environmentWizard') }}">
                <i class="fa fa-sliders fa-fw" aria-hidden="true"></i>
                {!! trans('installer_messages.environment.classic.back') !!}
            </a> -->
            <a class="button float-right" href="{{ route('LaravelVisualInstaller::database') }}">
