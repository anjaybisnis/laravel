			...
			<div class="container">
				<div class="row cat-nav-menu justify-content-center" id="cat-menu">
					<ul class="cat-menu">
						...
						@endforeach
						<li class="active"><a href="{{ url('browse/featured')}}">Produk Unggulan <br> <span>({{ count($tfItems)}})</span></a></li>
						<li class=""><a href="{{ url('browse/free')}}">Produk Gratis <br> <span>({{ count($tfreeItems)}})</span></a></li>
					</ul>
				</div>
			</div>
		</div>
